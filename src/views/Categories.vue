  ...
  <div>
      ...
      <div class="categories-wrap">
          <mt-navbar v-model="selected" >
            ...
            <mt-tab-item id="tab-item2">书画</mt-tab-item>
            <mt-tab-item id="tab-item3">青铜器</mt-tab-item>
            <mt-tab-item id="tab-item4">瓷器</mt-tab-item>
          </mt-navbar>
...
.mint-navbar .mint-tab-item.is-selected{
    border-bottom: 3px solid #705405 !important;
    color: #705405 !important;
}
</style>
